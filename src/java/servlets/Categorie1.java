    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(request.getParameter("idCategorie")==null) {
                ...
                Annonces1 annonces=new Annonces1(idCategorie);
                ...
                if(annonces.getIdCategorie()==0) {
                    ...
                    annonces.initListeAnnoncesCat();
                    if(annonces.getIdCategorie()==0) {
                        request.setAttribute("info", 2);
                    }
                    else {
                        request.setAttribute("annonces", annonces);
                        session.setAttribute("uriRetour", "./troc-3-"+annonces.getIdCategorie()+"-"+Objet.encodeTitre(annonces.getCategorie())+".html");
                    }
                }
            }
            }
