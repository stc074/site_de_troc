...
public class Annonces extends HttpServlet {
    private ListeRechercheAnnonces listeRecherche;
   
    @Override
    public void init() throws ServletException {
        super.init();
        this.listeRecherche=new ListeRechercheAnnonces();
        this.listeRecherche.initListe();
    }
    /** 
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            session.setAttribute("uriRetour", "./annonces-de-troc.html");
            ...
            recherche.initListeSousCategories(request);
            recherche.initLocal(request);
            recherche.initCondition();
            recherche.initTags(request);
            recherche.initListeAnnonces();
            request.setAttribute("listeRecherche", this.listeRecherche);
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            recherche.initTags(request);
            recherche.initListeAnnonces();
            //dout.println(recherche.getErrorMsg());
            request.setAttribute("listeRecherche", this.listeRecherche);
            request.setAttribute("recherche", recherche);
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/scripts/annonces.jsp");
            dispatch.forward(request, response);
