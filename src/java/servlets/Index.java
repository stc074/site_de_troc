...
public class Index extends HttpServlet {
    ...
    private ListeAnnonces listeAnnonces;
    ...
    public void init() throws ServletException {
        ...
        this.listeAnnonces=new ListeAnnonces();
        this.listeAnnonces.initListe();
    }
    /** 
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            boolean flag=this.listeAnnonces.testNelleAnnonce();
            if(flag==true) {
                this.listeAnnonces=new ListeAnnonces();
                this.listeAnnonces.initListe();
            }
            request.setAttribute("listeCategories", this.listeCategories);
            request.setAttribute("listeAnnonces", this.listeAnnonces);
