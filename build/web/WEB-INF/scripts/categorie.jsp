...
<c:catch var="ex">
    <c:set var="tagTitle" value="Trocs et échanges" scope="page"></c:set>
    <c:set var="tagDescription" value="Le bon troc - Annonces de trocs et d'échanges." scope="page"></c:set>
                           ...
                           <div class="colonneDroite">
                               <c:choose>
                                   <c:when test="${an.nbAnnoncesPage==0}">
                                       <div class="cadre2">
                                           <div class="info">Aucune annonce pour cette catégorie.</div>
                                       </div>
                                       <br/>
           <ul class="reseauxSoc">
               <li>
...
src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
                                   ...
                                   <c:when test="${an.nbAnnoncesPage>0}">
                                       <h2><c:out value="${an.nbAnnonces}"></c:out> annonces dans la catégorie <c:out value="${an.categorie}"></c:out></h2>
              <p></p>
           <ul class="reseauxSoc">
               <li>
                   <a href="https://twitter.com/share" class="twitter-share-button" data-lang="en">Tweet</a>
                                               ...
                                               <div class="pages">
                                                   ...
                                                   <c:forEach var="i" begin="${an.prem}" end="${an.der}" step="1">
                                                       <c:choose>
                                                           ...
                                                           <c:otherwise>
                                                               <span>[<a href="./troc1-${an.idCategorie}-${i}.html" title="PAGE #<c:out value="${i+1}"></c:out>"><c:out value="${i+1}"></c:out></a>]</span>
                                                           </c:otherwise>
                                                       </c:choose>
                                                   </c:forEach>
                                               </div>
