...
<a name="fb_share" type="button_count" share_url="<%= Datas.URLROOT %>">Cliquez pour partager !!!</a><script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript"></script>
           ...
           try {
               if(request.getAttribute("membre")!=null) {
                   ...
                   if(membre.getTest()==0) {
                   %>
           <div class="info">Pour vous inscrire gratuitement, utilisez le formulaire ci-dessous :</div>
           <br/>
           <div id="form">
               <%
               ...
               <fieldset>
                   ...
                   <form action="./inscription.html#form" method="POST">
                       ...
                       Objet.closeConnection();
                           ...
                           %>
                           <br/>
                           <div class="info">Vous êtes désormais inscrit(e), vous pouvez vous connecter !</div>
                           <br/>
                           <%
                           }
                       }
