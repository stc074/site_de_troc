...
<html>
<head>
<title>Troc et echange avec le bon troc - Message envoyé</title>
               ...
               if(request.getAttribute("info")!=null) {
                   ...
                   switch(info) {
                       ...
                       if(message.getIdPrec()!=0) {
                           ...
                           <div class="cadre2">
                               <br/>
                           <div class="info"><%= message.getMembreDestinataire().getPseudo() %> vous avait écrit, le <%= cal.get(cal.DATE) %>-<%= cal.get(cal.MONTH)+1 %>-<%= cal.get(cal.YEAR) %> :</div>
                           ...
                           <div class="cadre2">
                               <br/>
                           <div class="info">Vous lui aviez répondu, le <%= cal.get(cal.DATE) %>-<%= cal.get(cal.MONTH)+1 %>-<%= cal.get(cal.YEAR) %> :</div>
                           <%
                               ...
                               <div class="cadre2">
                                   <br/>
                               <div class="info">Vous avez écrit à <%= message.getMembreDestinataire().getPseudo() %>, le <%= cal.get(cal.DATE) %>-<%= cal.get(cal.MONTH)+1 %>-<%= cal.get(cal.YEAR) %> :</div>
                               <%
                               }
                       %>
                       ...
                       <br/>
                       <%
                       if(message.getIdPrec()!=0&&message.getTest()==0) {
                           %>
                           <div class="cadre2">
                           <div class="info">Pour ré-envoyer un message à <%= message.getMembreDestinataire().getPseudo() %>, utilisez le formulaire ci-dessous :</div>
                           </div>
                           <br/>
                           <div id="form">
                               <%
                               ...
                               <% } %>
                               <fieldset>
                                   <legend>Envoyer un message à <%= message.getMembreDestinataire().getPseudo() %></legend>
                            ...
                            <script type="text/javascript">
                                    CKEDITOR.replace( 'contenuMsg' );
                                       ...
                                       <%
                       } else if(message.getIdPrec()!=0&&message.getTest()==1) { %>
                       <br/>
                       <div class="cadre2">
                           <br/>
