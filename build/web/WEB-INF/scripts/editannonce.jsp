...
<html>
<head>
<title>Troc et echange avec le bon troc - Éditer une annonce</title>
...
<a name="fb_share" type="button_count" share_url="<%= Datas.URLROOT %>">Cliquez pour partager !!!</a><script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript"></script>
           ...
           <g:plusone></g:plusone>
           <br/>
           <h1>Le bon troc - Editer une annonce</h1>
           <%
           try {
               if(request.getAttribute("info")!=null) {
                   ...
                   switch(info) {
                       ...
                       %>
                       <h2>Troque <%= annonce.getTitre() %> contre <%= annonce.getTitreContre() %></h2>
                       <div class="info">Dernières modifications : le <%= cal.get(cal.DATE) %>-<%= cal.get(cal.MONTH)+1 %>-<%= cal.get(cal.YEAR) %>.</div>
                       <br/>
                       <div class="info">Pour modifier les données de votre annonce, utilisez le formulaire ci-dessous :</div>
                       <br/>
                       <div id="form">
                           <%
                           ...
                           <fieldset>
                               ...
                               <form action="./edit-annonce.html#form" method="POST">
                                   ...
                                   <div>Description de ce que je propose :</div>
                                   ...
                                   <br/>
                                           ...
                                           <div>Description de ce que je veux en échange :</div>
                       ...
                       Objet.closeConnection();
                           ...
                           %>
                           <script type="text/javascript">
                               window.location.href="./edit-annonce2.html";
                           </script>
                               <%
                               }
                       }
