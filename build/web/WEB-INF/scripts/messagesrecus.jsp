...
<html>
<head>
<title>Troc et echange avec le bon troc - Messages recus</title>
...
<a name="fb_share" type="button_count" share_url="<%= Datas.URLROOT %>">Cliquez pour partager !!!</a><script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript"></script>
           ...
           <g:plusone></g:plusone>
           <br/>
           <h1>Le bon troc - Messages reçus</h1>
           <%
           try {
               if(request.getAttribute("info")!=null) {
                   ...
                   switch(info) {
                       ...
                       Objet.getConnection();
                       String query="SELECT t1.id,t1.objet,t1.timestamp,t1.etat,t2.pseudo FROM table_messages AS t1,table_membres AS t2 WHERE t1.id_membre_destinataire=? AND t2.id=t1.id_membre_expediteur ORDER BY t1.timestamp DESC";
                       ...
                       while(result.next()) {
                           ...
                           <div class="cadre2">
                               <div>
                                   <a href="./message-recu-<%= idMessage %>.html" title="CONSULTER CE MESSAGE" rel="nofollow"><%= objet %></a>
                                   <%
                                   if(etat==0) { %>
                                   ...
                                   <a href="./efface-message-1-<%= idMessage %>.html" title="ÉFFACER CE MESSAGE" rel="nofollow">Éffacer</a>
                               </div>
                           </div>
                               <br/>
                               <%
